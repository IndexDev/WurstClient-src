 ...
 public static enum JsonUtils
 {
   ...
   public static void toJson(JsonElement json, Path path) throws IOException, JsonException {
     try (BufferedWriter writer = Files.newBufferedWriter(path, new java.nio.file.OpenOption[0])) {
   ...
   public static boolean getAsBoolean(JsonElement json) {
     if (!isBoolean(json)) {
       throw new JsonException();
     }
...
/* Location:              C:\Users\Administrator\Desktop\WURST BY INDEX.jar!\net\wurstclien\\util\json\JsonUtils.class
